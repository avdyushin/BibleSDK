...
class PlainTextFormatterTests: XCTestCase {

    var verses: [Verse]!
    var converter: VerseFormatter<PlainTextVerseFormatter>!

    override func setUp() {
        super.setUp()

        verses = BibleSDK().findByReference("Gen 1:2-4").first!.value
        converter = VerseFormatter<PlainTextVerseFormatter>()
    }
